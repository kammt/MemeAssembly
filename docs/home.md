?> MemeAssembly v1.0 is out! Check out the [changelog page](changelog) for more information
...
- Speed - the MemeASM-compiler converts your code into x86_64-Assembly to make it run blazingly fast! Due to its high level of optimisation, no Optimisation-flags are necessary.
- Fun-Factor - Consider this: Your code might be simple to understand, but is it fun to understand? With MemeAssembly, your code will be much more fun to look at!
- Minimalism - Can you even remember all the commands that your 'shiny new' programming language has to offer? Are you overwhelmed and confused by all the ways a modern programming language can be used for? Well look no further than MemeAssembly! MemeASM is your best choice, since it only supports a tiny fraction of instructions.
